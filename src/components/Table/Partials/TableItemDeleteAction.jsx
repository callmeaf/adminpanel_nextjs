...
let deleteLoadingTimeout;

const TableItemDeleteAction = ({ onDelete }) => {
  ...
  const confirmHandler = () => {
    if (confirmed) {
      ...
      setLoading(true);
      if (deleteLoadingTimeout) {
        clearTimeout(deleteLoadingTimeout);
      }
      deleteLoadingTimeout = setTimeout(() => {
        setLoading(false);
        setConfirmed(true);
      }, 500);
    }
...
export default TableItemDeleteAction;
